...
public class cluster extends Frame
	...
	public cluster() {
		...
		Image image = toolkit.getImage(getClass().getResource("icon.gif"));
		JButton jbutton = new JButton("", new ImageIcon(toolkit.getImage(getClass().getResource("load.gif"))));
		JButton jbutton1 = new JButton("", new ImageIcon(toolkit.getImage(getClass().getResource("distances.gif"))));
		JButton jbutton2 = new JButton("", new ImageIcon(toolkit.getImage(getClass().getResource("cluster.gif"))));
		JButton jbutton3 = new JButton("", new ImageIcon(toolkit.getImage(getClass().getResource("vrml.gif"))));
		JButton jbutton4 = new JButton("", new ImageIcon(toolkit.getImage(getClass().getResource("find.gif"))));
		JButton jbutton5 = new JButton("", new ImageIcon(toolkit.getImage(getClass().getResource("cluster.gif"))));
		JButton jbutton6 = new JButton("", new ImageIcon(toolkit.getImage(getClass().getResource("som.gif"))));
		JButton jbutton7 = new JButton("", new ImageIcon(toolkit.getImage(getClass().getResource("pc.gif"))));
		JButton jbutton8 = new JButton("", new ImageIcon(toolkit.getImage(getClass().getResource("kmeans.gif"))));
		setIconImage(image);
	...
	public void actionPerformed(ActionEvent actionevent) {
		if (actionevent.getActionCommand() == "About J-Express") {
			...
			Toolkit toolkit = Toolkit.getDefaultToolkit();
			Image image = toolkit.getImage(getClass().getResource("ab.jpg"));
